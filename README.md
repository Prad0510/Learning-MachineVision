...
Image Reconstruction: Combining the smoothed image with the Laplacian edge map to produce a final, crisp output where details like mountain ridges and paths are clearly defined.

🛠️ Tools Used
Language: PythonLibraries:
OpenCV: The primary engine for image math and filtering.NumPy: For handling images as numerical matrices.Matplotlib: For side-by-side visual comparisons and histogram plotting.
